  ...
  return (
    <div className="min-h-screen">
      ...
      <article className="mx-auto max-w-2xl px-5 py-16 text-[#2a2a2a]">
        ...
        <h1 className="serif-italic mt-3 text-5xl text-[#111]">Privacy</h1>
        <p className="mt-8">
        ...
        <h2 className="serif mt-10 text-2xl text-[#111]">Screenshots</h2>
        <p className="mt-3">
        ...
        <h2 className="serif mt-10 text-2xl text-[#111]">Places and maps</h2>
        <p className="mt-3">
        ...
        <h2 className="serif mt-10 text-2xl text-[#111]">Reservations</h2>
        <p className="mt-3">
        ...
        <h2 className="serif mt-10 text-2xl text-[#111]">Account</h2>
        <p className="mt-3">
