  ...
  return (
    <div className="min-h-screen">
      ...
      <article className="prose-legal mx-auto max-w-2xl px-5 py-14 md:py-16">
        ...
        <h1 className="serif-italic mt-3 text-5xl text-[var(--ink)]">Terms</h1>
        <p className="mt-8">
        ...
        <h2 className="serif mt-10 text-2xl">What we do</h2>
        ...
        <h2 className="serif mt-10 text-2xl">What we do not do</h2>
        <ul className="mt-3 list-disc space-y-2 pl-5">
        ...
        <h2 className="serif mt-10 text-2xl">Attribution</h2>
        <p className="mt-3">
